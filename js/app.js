...
function formatearProductoApi(item, codGrupo, nombreGrupo, codSubgrupoFallback, nombreSubgrupoFallback, proxyBaseUrl) {
    ...
    return {
        ...
        PrecioBsStr: (precioUsd * appState.tasaOficial).toLocaleString('es-VE', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
        PrecioCajaUsd: precioCajaNum.toFixed(2), PrecioCajaNum: precioCajaNum,
        PrecioCajaBsStr: (precioCajaNum * appState.tasaOficial).toLocaleString('es-VE', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
